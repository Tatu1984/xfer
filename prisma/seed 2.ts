...
async function main() {
  ...
  const superAdmin = await prisma.user.upsert({
    where: { email: "superadmin@paypal.com" },
    update: {},
    create: {
      email: "superadmin@paypal.com",
  ...
  const vendor = await prisma.user.upsert({
    where: { email: "vendor@paypal.com" },
    update: {},
    create: {
      email: "vendor@paypal.com",
      passwordHash: password,
      firstName: "Business",
      lastName: "Owner",
  ...
  console.log("=".repeat(50));
  console.log("\n📧 Super Admin: superadmin@paypal.com");
  console.log("📧 Admin:       admin@paypal.com");
  console.log("📧 Vendor:      vendor@paypal.com");
  console.log("📧 User:        user@paypal.com");

...
import { Search, MoreHorizontal, Store, Eye, Ban, CheckCircle, DollarSign } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {vendors.filter((v) => v.kybStatus === "PENDING").length}
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(vendors.reduce((sum, v) => sum + v.totalVolume, 0))}
            </div>
          </CardContent>
        </Card>
      </div>
            ...
            <TableBody>
              {filteredVendors.map((vendor) => (
                <TableRow key={vendor.id}>
                  ...
                  <TableCell>{formatCurrency(vendor.totalVolume)}</TableCell>
